                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-baca42ed0532da216c874051164eca45"' : 'data-target="#xs-components-links-module-AppModule-baca42ed0532da216c874051164eca45"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-baca42ed0532da216c874051164eca45"' :
                                            'id="xs-components-links-module-AppModule-baca42ed0532da216c874051164eca45"' }>
                                            <li class="link">
